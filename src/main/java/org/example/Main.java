...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Alumno> alumnos = Arrays.asList(
                ...
                new Alumno("Ricardo", 6.0, "Web"),
                new Alumno("Lina", 8.0, "Java"),
                new Alumno("Josefa", 6, "Python"),
                new Alumno("Yohana", 8.5, "Base de Datos"),
                new Alumno("Clara", 10.0, "python")
        );
        ...
        List<Producto> productos = Arrays.asList(
                new Producto("Pantalla", "Tecnología", 250.0, 15),
                new Producto("Silla", "Oficina", 150.0, 10),
                new Producto("Mouse", "Tecnología", 40.0, 50),
                new Producto("Escritorio", "Oficina", 120.0, 5),
        ...
        List<Empleado> empleados = Arrays.asList(
                new Empleado("Gines", "Ventas", 2200.0, 28),
                new Empleado("Mirtha", "IT", 3000.0, 35),
                new Empleado("Ana Clara", "RRHH", 1900.0, 25),
                new Empleado("Juanes", "Ventas", 2100.0, 23),
